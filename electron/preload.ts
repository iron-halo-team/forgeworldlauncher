...
const launcherApi: LauncherApi = {
  ...
  startPasswordRecovery: (identifier) => ipcRenderer.invoke(IPC_CHANNELS.startPasswordRecovery, identifier),
  resendPasswordRecovery: (username) => ipcRenderer.invoke(IPC_CHANNELS.resendPasswordRecovery, username),
  verifyPasswordRecovery: (username, code) => ipcRenderer.invoke(IPC_CHANNELS.verifyPasswordRecovery, username, code),
  completePasswordRecovery: (username, resetToken, newPassword) => ipcRenderer.invoke(
    IPC_CHANNELS.completePasswordRecovery,
    username,
    resetToken,
    newPassword,
  ),
