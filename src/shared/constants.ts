...
export const IPC_CHANNELS = {
  ...
  resendPasswordRecovery: 'launcher:auth-recovery-resend',
  verifyPasswordRecovery: 'launcher:auth-recovery-verify',
  completePasswordRecovery: 'launcher:auth-recovery-complete',
